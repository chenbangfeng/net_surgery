...
table.insert(model, {'fc6-conv', cudnn.SpatialConvolution(256, 4096, 6, 6, 1, 1, 0, 0, 1)})
table.insert(model, {'relu6', cudnn.ReLU(true)})
table.insert(model, {'drop6', nn.Dropout(0.500000)})
table.insert(model, {'fc7-conv', cudnn.SpatialConvolution(4096, 4096, 1, 1, 1, 1, 0, 0, 1)})
table.insert(model, {'relu7', cudnn.ReLU(true)})
table.insert(model, {'drop7', nn.Dropout(0.500000)})
table.insert(model, {'fc8-conv', cudnn.SpatialConvolution(4096, 1000, 1, 1, 1, 1, 0, 0, 1)})
return model